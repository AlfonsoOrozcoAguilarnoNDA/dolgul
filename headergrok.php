...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><i class="fas fa-plus-circle fa-2x text-warning"></i> <a class="nav-link" href="nuevo_ticket.php">Nuevo Ticket</a></li>
            <li class="nav-item"><i class="fas fa-folder-open fa-2x text-danger"></i> <a class="nav-link" href="tickets_abiertos.php">Abiertos</a></li>
            <li class="nav-item"><i class="fas fa-folder fa-2x text-success"></i> <a class="nav-link" href="tickets_cerrados.php">Cerrados</a></li>
