...
// Modelo: Grok (xAI) - Chunk 18: tickets_cerrados.php
session_start();
require_once 'headergrok.php';
echo tickets_cerrados();

function tickets_cerrados(){
global $link;    
...
$query = "SELECT t.tickets_id, t.tickets_idempresa, t.empresas_id, t.tickets_subject, t.tickets_timestamp, 
          ...
          $where 
          ORDER BY t.horacierre DESC 
          LIMIT $offset, $items_por_pagina";

$result = mysqli_query($link, $query);
?>

<h2 class="mb-4">Tickets Cerrados</h2>
...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php if (mysqli_num_rows($result) == 0): ?>
            <tr><td colspan="10" class="text-center py-4 text-muted">No hay tickets cerrados que coincidan con tus permisos.</td></tr>
        <?php endif; ?>
        </tbody>
    </table>
</div>
