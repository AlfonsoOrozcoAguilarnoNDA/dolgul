...
/*
 * DOLGUL - Sistema de Tickets (Vigilancia)
 * Stub de compatibilidad: conserva la URL/menu original tickets_cerrados.php
 * Llama a la función consolidada en tickets_lista.php
 */
session_start();
require_once 'headergrok.php';
require_once 'tickets_lista.php';
echo tickets_lista('cerrados');
?>
